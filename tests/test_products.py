...
class TestProducts:
    ...
    @pytest.mark.products
    def test_get_product_plans_success(
    ...
    @pytest.mark.products
    def test_create_product_admin_success(
    ...
    @pytest.mark.products
    def test_create_product_user_forbidden(
    ...
    @pytest.mark.products
    def test_update_product_admin_success(
        self, client: TestClient, test_product: Product, admin_headers: dict
    ):
    ...
    @pytest.mark.products
    def test_update_product_user_forbidden(
        self, client: TestClient, test_product: Product, auth_headers: dict
    ):
    ...
    @pytest.mark.products
    def test_delete_product_admin_success(
        self, client: TestClient, test_product: Product, admin_headers: dict
    ):
    ...
    @pytest.mark.products
    def test_delete_product_user_forbidden(
        self, client: TestClient, test_product: Product, auth_headers: dict
    ):
...
class TestProductsCaching:
    ...
    @pytest.mark.products
    @pytest.mark.integration
    def test_product_plans_caching(
        self, client: TestClient, test_product_plan: ProductPlan
    ):
...
class TestProductsRateLimiting:
    ...
    @pytest.mark.products
    def test_products_rate_limiting_different_endpoints(
        self, client: TestClient, test_product: Product
    ):
