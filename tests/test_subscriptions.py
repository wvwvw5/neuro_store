...
class TestSubscriptions:
    ...
    def test_create_subscription_success(
        ...
        subscription_data = create_test_subscription_data(
            test_product_plan.product_id, test_product_plan.plan_id
        )

        response = client.post(
            "/api/v1/subscriptions/", json=subscription_data, headers=auth_headers
        )
    ...
    @pytest.mark.subscriptions
    def test_create_subscription_insufficient_balance(
        self,
        client: TestClient,
        auth_headers: dict,
        test_user: User,
    ...
    @pytest.mark.subscriptions
    def test_create_subscription_invalid_product(
        self, client: TestClient, auth_headers: dict
    ):
        """Тест создания подписки с несуществующим продуктом"""
        subscription_data = {"product_id": 99999, "plan_id": 1}
    ...
    @pytest.mark.subscriptions
    def test_create_subscription_no_auth(
        self, client: TestClient, test_product_plan: ProductPlan
    ):
    ...
    def test_get_subscription_by_id_success(
        ...
        response = client.get(
            f"/api/v1/subscriptions/{subscription.id}", headers=auth_headers
        )
    ...
    @pytest.mark.subscriptions
    def test_get_subscription_other_user_forbidden(
        self,
        client: TestClient,
        auth_headers: dict,
        test_product_plan: ProductPlan,
    ...
    def test_cancel_subscription_success(
        ...
        response = client.put(
            f"/api/v1/subscriptions/{subscription.id}/cancel", headers=auth_headers
        )
    ...
    def test_get_subscription_status_success(
        ...
        response = client.get(
            f"/api/v1/subscriptions/{subscription.id}/status", headers=auth_headers
        )
