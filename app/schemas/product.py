...
class ProductBase(BaseModel):
    ...
    category: str = Field(..., min_length=1, max_length=100, description="Категория продукта")
    api_endpoint: Optional[str] = Field(None, max_length=500, description="API endpoint продукта")
...
class PlanBase(BaseModel):
    ...
    max_requests_per_month: Optional[int] = Field(None, gt=0, description="Максимум запросов в месяц")
