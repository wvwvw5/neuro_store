from sqlalchemy import Column, BigInteger, ForeignKey, String, DateTime, Boolean, Numeric, Text
...
class Payment(Base):
    ...
    order_id = Column(BigInteger, ForeignKey("orders.id", ondelete="RESTRICT", onupdate="CASCADE"), nullable=False, unique=True, comment="ID заказа")
    ...
    status = Column(String(50), nullable=False, default="pending", comment="Статус платежа")
