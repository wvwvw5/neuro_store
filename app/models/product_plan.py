...
class ProductPlan(Base):
    ...
    is_available = Column(BigInteger, default=True, comment="Доступен ли план для продукта")
    created_at = Column(DateTime(timezone=True), server_default=func.now(), comment="Дата создания связи")
