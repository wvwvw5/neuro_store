...
class AuditLog(Base):
    ...
    operation = Column(String(20), nullable=False, comment="Тип операции (INSERT/UPDATE/DELETE)")
    ...
    timestamp = Column(DateTime(timezone=True), server_default=func.now(), comment="Время операции")
