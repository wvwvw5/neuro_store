...
class Settings(BaseSettings):
    ...
    DATABASE_URL: str = "postgresql+psycopg2://postgres:postgres@localhost:5432/neuro_store"
    DATABASE_URL_ASYNC: str = "postgresql+asyncpg://postgres:postgres@localhost:5432/neuro_store"
    TEST_DATABASE_URL: str = "postgresql+psycopg2://postgres:postgres@localhost:5432/neuro_store_test"
